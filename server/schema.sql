...
-- Durable server-side transcription and analysis queue. The API only acknowledges
-- an intake after both files are safely stored and this row is committed. A
-- separate worker claims queued/retryable rows using a lease.
